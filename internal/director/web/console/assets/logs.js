...
(function ($) {
  ...
  function validate(b) {
    ...
    } else if (!ip(b.PublicIP)) {
      errors['s-pub'] = 'Enter a complete IPv4 address.';
    }
    for (const key of ['PrivateIP','DestIP']) if (b[key] && !ip(b[key])) errors[fields[key]] = 'Enter a complete IPv4 address.';
