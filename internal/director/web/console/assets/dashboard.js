...
window.YesLogsDashboard = (() => {
  ...
  function mount(root,options) {
    ...
    root.innerHTML=`<section class="dashboard" aria-label="${director?'Director':'ISP'} dashboard">
      ...
      <button class="btn out sm" data-go="Logs"><span class="ms">search</span>Search logs</button><button class="btn out sm" data-go="Reports"><span class="ms">summarize</span>Reports</button>${director?'<button class="btn out sm" data-go="ISPs"><span class="ms">add</span>Add ISP</button>':''}<button class="btn out sm" data-go="Devices" data-add="true"><span class="ms">add</span>Add device</button>
